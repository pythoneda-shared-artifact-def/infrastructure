...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-events-infrastructure = {
      ...
      url = "github:pythoneda-shared-artifact-def/events-infrastructure/0.0.87";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "infrastructure";
        version = "0.0.16";
        sha256 = "0ych72ccf4lnpp1k7r7ahzyr3f5kkqxpli12l5ay71y9xrjpiwbp";
        pname = "${org}-${repo}";
        ...
        pythoneda-shared-artifact-infrastructure-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-artifact-events} ${pythoneda-shared-artifact-events-infrastructure} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-artifact-shared} ${pythoneda-shared-pythonlang-infrastructure}; do
